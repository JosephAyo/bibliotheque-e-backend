...
from app.helpers.email_templates import get_book_due_soon_email
from ..repository import user as user_repository
from ..database.base import SessionLocal
from ..helpers.send_email import send_email_async

from app.repository.check_in_out import get_books_due


async def send_due_soon_reminders():
    due_time = datetime.utcnow() + timedelta(days=14)

    check_outs: List[CheckInOut] = get_books_due(due_time, SessionLocal())
